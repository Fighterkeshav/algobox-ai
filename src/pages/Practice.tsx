...
export default function Practice() {
  ...
  useEffect(() => {
    const refreshCustomProblems = () => setCustomProblems(getCustomProblems());

    refreshCustomProblems();
    window.addEventListener("storage", refreshCustomProblems);
    window.addEventListener("focus", refreshCustomProblems);

    return () => {
      window.removeEventListener("storage", refreshCustomProblems);
      window.removeEventListener("focus", refreshCustomProblems);
    };
  }, []);
